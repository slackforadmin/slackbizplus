...
<table style="width: auto; min-width: 60%; margin: 40px auto; border-collapse: collapse; font-size: 13px; line-height: 1.5; background-color: #ffffff; border: 1px solid #e1e4e8;">
  <thead>
    <tr style="background: #f8f9fa;">
      ...
      <th style="padding: 12px 15px; border: 1px solid #e1e4e8; text-align: center; font-weight: 700; color: #1d1c1d; white-space: nowrap;">공식 참조 문서</th>
    </tr>
  </thead>
  <tbody>
    <tr>
