...
<div style="display: flex; justify-content: center; width: 100%; background-color: #f6f8fa; border-radius: 8px; overflow: hidden;">
  <img src="https://github.com/user-attachments/assets/0000d7f2-9b60-48c4-9512-b0c59b19fd28" 
       alt="image" 
       loading="lazy"
       style="width: 100%; max-width: 1200px; height: 400px; object-fit: cover; border-radius: 8px; display: block;">
</div>
